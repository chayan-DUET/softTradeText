...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Text Trade | Product Management</title>
		...
		<!-- BEGIN PAGE LEVEL PLUGINS add-product -->
        ...
        <!-- END PAGE LEVEL PLUGINS add-product -->
		
		 <!-- BEGIN PAGE LEVEL PLUGINS  product list-->
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
       ...
       @include('admin.include.header')
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2019 &copy; Text Trade.
                <a href="https://textradebd.com/home/" title="A Smart Soft Solution" target="_blank">Soft Trade</a>
            </div>
        ...
        <script src="{{asset('public/admin/')}}/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
		...
		<!-- BEGIN PAGE LEVEL PLUGINS add-product  -->
        <script src="{{asset('public/admin/')}}/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS add-product -->
		<!-- BEGIN PAGE LEVEL PLUGINS product list -->
