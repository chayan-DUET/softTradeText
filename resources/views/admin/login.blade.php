...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{asset('/admin/')}}/assets/layouts/layout/img/textrade.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
             ...
             <!--   <div class="create-account">
				...
				<div class="create-account">
					...
					<a href="{{url('/register')}}" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                        <span class="title">Register for Admin</span>
                                        <span class="badge badge-success"></span>
                                    </a>
                        
                    </p>
					 <p>
					<a href="{{url('/registerclient')}}" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                        <span class="title">Register for Client</span>
                                        <span class="badge badge-success"></span>
                                    </a>
